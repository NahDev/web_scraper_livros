...
from nova_fronteira.scraper.categories import fetch_categories
from nova_fronteira.scraper.listings import scrape_listings
from nova_fronteira.scraper.products import scrape_products
...
def start(
    ...
    logger.info(
        "Starting Nova Fronteira pipeline | run_id=%s max_categories=%s max_pages=%s max_products=%s",
        run_id,
        max_categories,
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Nova Fronteira bookstore scraper")
